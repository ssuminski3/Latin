...
export default function Home() {
    return (
        <div className="w-full max-sm:h-screen sm:p-10 sm:m-auto flex justify-center items-center ">
            <div className="lg:w-3/5 w-full lg:m-auto text-center">
                <div className="sm:m-10 text-xl sm:text-3xl text-white rounded-3xl p-10 sm:p-20 bg-gradient-to-r from-slate-900 to-slate-950">
